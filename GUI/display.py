...
class Application(wx.Frame):
    def __init__(self):
        ...
        # Настройка фона окна в стиле Windows 11
        self.SetBackgroundColour("#FFFFFF")
        panel = wx.Panel(self)
        panel.SetBackgroundColour("#FFFFFF")
        main_sizer = wx.BoxSizer(wx.VERTICAL)

        # Верхняя панель с современным дизайном
        top_panel = wx.Panel(panel)
        top_panel.SetBackgroundColour("#F3F3F3")
        top_sizer = wx.BoxSizer(wx.HORIZONTAL)

        # Используем системный шрифт Segoe UI
        ...
        # Добавляем пустое значение в начало списка годов
        ...
        # Добавляем пустое значение в начало списка жанров
        ...
        # Размещаем элементы в верхней панели
        ...
        # Привязка событий для мгновенного обновления:
